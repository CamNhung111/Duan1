 ...
 * @author Admin
 */
public class fomDangNhap extends javax.swing.JFrame {

    /**
     * Creates new form fomDangNhap
     */
    public fomDangNhap() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fomDangNhap.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new fomDangNhap().setVisible(true);
            }
        });
    }
